...
<div class = "col-md-8" style = "padding: 0; border-left: solid 1px black; border-right: solid 1px black; ">
	<div class = "container-fluid" style = "margin: 0px; padding: 0px; height: 1241px;">
		<div class = "row" style = "margin: 0;">
			<ul class="nav nav-tabs">
			  ...
			  <li role="presentation"><a href="neutron_graphs.php">Neutron</a></li>
			  <li role="presentation"><a href="glance_graphs.php">Glance</a></li>
			  <li role="presentation"  class="active"><a href="cinder_graphs.php">Cinder</a></li>
		...
		<div class = "row" style = "margin: 0;">
			<h3 style = "text-align: center; color: green; padding-bottom: 10px">Uptimes of Cinder services</h3>
				<div class = "col-md-3" style = "padding: 0;"></div>
				<div class = "col-md-6" style = "padding: 0; text-align: center;">
				
				<?php include 'cinder_uptime.php';?>
	...
	<div class = "row" style = "margin: 0;">
		...
		<?php	system("perl cinder.pl");	?>
		<img src = "./graphs/cinder.png" title = "Cinder Services Uptime" width = "100%" height = "100%" style = "margin-top: 50px;">
	</div>
	</div>
	</div>
</div>
