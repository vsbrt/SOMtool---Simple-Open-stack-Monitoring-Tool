...
<ol class = "breadcrumb" style = "padding: 2px 0 2px 25px; margin: 0; background-color: white;">
  ...
  <li class = "active">Register New Users</li>
  <li></li>
</ol>
</div>
</div>
	...
	<div class = "container-fluid" style = "margin: 0px; padding: 0px;">
		<div class = "row" style = "margin: 0;">
			<ul class="nav nav-tabs">
			  <li role="presentation" class = "active"><a href = "accounts.php" class = "active">Register New Users</a></li>
			  <li role="presentation"><a href = "change.php">Change Credentials</a></li>
			</ul>	
		</div>
		
		<div class = "row" style = "margin: 0;">
			<h3 style = "text-align: center; color: green; padding-bottom: 10px">Register New Users</h3>
...
<input type = "password" class="form-control" placeholder="Password" name = "password" method = "POST" style = "margin-top: 10px;"></input>
</br>

<input type = "password" class="form-control" placeholder="Retype Password" name = "rpassword" method = "POST" style = "margin-top: 10px;"></input>
</br>								
	</form>	
							
<button form = "login" type="submit" name = "login" class="btn btn-success">Register</button>
...
elseif(empty($_POST["username"]) && empty($_POST["password"]) && empty($_POST["rpassword"]) )
{
	echo '
...
elseif(isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["rpassword"]) )
{
