...
<div class = "col-md-8" style = "padding: 0; border-left: solid 1px black; border-right: solid 1px black;">
	<div class = "container-fluid" style = "margin: 0px; padding: 0px; height: 1241px;">
		<div class = "row" style = "margin: 0;">
			<ul class="nav nav-tabs">
			  ...
			  <li role="presentation"  class="active"><a href="heat_graphs.php">Heat</a></li>
			  <li role="presentation"><a href="keystone_graphs.php">Keystone</a></li>
			</ul>			
		</div>
		
		<div class = "row" style = "margin: 0;">
			<h3 style = "text-align: center; color: green; padding-bottom: 10px">Uptimes of Heat services</h3>
				<div class = "col-md-3" style = "padding: 0;"></div>
				<div class = "col-md-6" style = "padding: 0; text-align: center;">
				
				<?php include 'heat_uptime.php';?>
	...
	<div class = "row" style = "margin: 0;">
		...
		<?php	system("perl heat.pl");	?>
		<img src = "./graphs/heat.png" title = "heat Services Uptime" width = "100%" height = "100%" style = "margin-top: 50px;">
	</div>
	</div>
	</div>
</div>
